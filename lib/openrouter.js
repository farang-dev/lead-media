...
exports.translateArticleToJapanese = translateArticleToJapanese;
...
async function generateMetaData(title, content) {
...
async function translateArticleToJapanese(title, content) {
    if (!OPENROUTER_API_KEY) {
        console.error('OpenRouter API key not configured');
